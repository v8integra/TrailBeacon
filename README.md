...
Not yet built: the actual auto-share party broadcast, the marker list/browser panel, the tracking arrow, and the arrow options window. See [CLAUDE.md](CLAUDE.md) for the full feature spec.
